...
const Login = () => {
    return (
        <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 mx-auto shadow-2xl border border-spacing-1 border-cyan-400 p-5 rounded-md  mb-10">
    <div className="flex justify-center mx-auto">
        {/* <img className="w-auto h-7 sm:h-8" src="https://merakiui.com/images/logo.svg" alt=""> */}
    </div>

    <form className="mt-6 mx-auto shadow-2xl border border-spacing-1 border-cyan-400 p-5 rounded-md  mb-10">
        <div>
    ...
    <p className="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <Link to="/SingUp" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</Link></p>
</div>
    );
};
