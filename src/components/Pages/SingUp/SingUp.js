...
const SingUp = () => {
    return (
        <div>
            <section class="bg-white dark:bg-gray-900 mx-auto shadow-2xl border border-spacing-1 border-cyan-400 p-5 rounded-md  mb-10">
    <div class="flex justify-center min-h-screen ">
        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5 mx-auto shadow-2xl border border-spacing-1 border-cyan-400 p-5 rounded-md  mb-10">
            <div class="w-full">
